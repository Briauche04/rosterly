...
export default function TeamPage() {
  ...
  // ---- Inline styles (no border shorthand anywhere) ----
  ...
  const sSearch: React.CSSProperties = {
    padding: '8px 10px',
    borderRadius: 12,
    borderWidth: 1, borderStyle: 'solid', borderColor: '#d9cfbf',
    background: '#f7f2e9',
    color: '#3a3e2d',
    minWidth: 240,
  };

  const sNote: React.CSSProperties = {
    background: '#f4eee2', color: '#6b6458',
    borderRadius: 999, padding: '10px 16px', fontSize: 12, textAlign: 'center' as const, margin: '8px 0'
  };
  ...
  const sRow: React.CSSProperties = {
    ...
    background: '#f7f2e9',
    borderWidth: 1, borderStyle: 'solid', borderColor: '#e3dacb',
  };
  ...
  const sBadge: React.CSSProperties = {
    ...
    borderWidth: 1, borderStyle: 'solid', borderColor: '#d9cfbf',
    background: '#f0e7d8', color: '#4f553d'
  };

  return (
    <main style={sMain} dir="rtl" data-page="team-inline-v2">
      ...
      <section style={sWrap}>
        ...
        {errorMsg && <div style={{...sNote, background:'#fde1e1', color:'#7c2222'}}>שגיאה בטעינת רשימת הצוות.</div>}
