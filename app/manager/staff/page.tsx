...
export default function StaffPage() {
  ...
  async function handleCreate(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      // >>> crucial: include the Supabase access token
      ...
      <section className="card" style={{ maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ display: 'flex', gap: 8, alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
          <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
            ...
            <span className="pill small">יוצר משתמש כניסה (סיסמה = טלפון) + רשומת עובד + תפקיד</span>
          </div>
          <input
          ...
          >
            ...
            <form onSubmit={handleCreate}>
              <div style={grid2}>
                ...
                <L label="גלובלי">
                  <input type="checkbox" checked={form.global_worker}
